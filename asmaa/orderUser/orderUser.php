...
<body>
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid h-auto">
            <a class="navbar-brand" href="#">
                <img src="php project/cafeteria-logo.png" alt="cafeteria" width="40" height="30">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <!-- Profile pic inside collapse -->
                <div class="d-flex align-items-center mt-3 mt-lg-0">
                    <div class="px-3">
                    <img class="rounded-circle border-2 border-black" src=""
    ...
    <div class="container mt-5">
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 latestOrder">
