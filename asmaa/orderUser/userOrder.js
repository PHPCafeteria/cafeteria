...
try {
    fetch("http://localhost/cafeteria/asmaa/orderUser/Product.php")
        .then(response => {
            if (!response.ok) {
...
try {
    fetch("http://localhost/cafeteria/asmaa/orderUser/latestPrudect.php",{
        method: 'POST',
        headers: {
    ...
    $('.confirm').on("click", function() {
        try {
            ...
            fetch("http://localhost/cafeteria/asmaa/orderUser/insertOrder.php", {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
